...
let c = {
    ...
    //         if (this.ctx.isPointInPath(path.path, x, y)) {
    //             if (path.name === 'circleCInner') {
    //                 path.color = this.hoverColor;
    //                 path.fillColor = this.hoverColor;

    //                 const closestCircleCInner = this.getClosestCircleCInner(path, x, y);


    //                 console.log('path', path);
    //                 console.log('closest', closestCircleCInner);
    //                 if (closestCircleCInner) {
    //                     closestCircleCInner.color = this.closeCircleColor;
    //                 }
    //             }
    //         } else {
